...
func TestBTree_Iterator(t *testing.T) {
	...
	// 2.BTree有数据
	bt1.Put([]byte("code"), &data.LogRecordPos{Fid: 1, Offset: 11})
	...
	// 3.多条数据
	bt1.Put([]byte("acee"), &data.LogRecordPos{Fid: 2, Offset: 22})
	bt1.Put([]byte("eede"), &data.LogRecordPos{Fid: 3, Offset: 33})
	bt1.Put([]byte("bbcd"), &data.LogRecordPos{Fid: 4, Offset: 44})
